...
namespace CustomControls
{
    public class NepaliDate
    {
        ...
        public int nepaliYear, nepaliMonth, nepaliDate;
        public int englishYear, englishMonth, englishDate;
        public int weekDay;
        public int[] englishMonths, englishLeapMonths;
        public int[][] nepaliMonths;
        public static string[] nepaliMonthsWords = { "Baishak", "Jestha", "Ashad", "Shrawn", "Bhadra", "Ashwin", "kartik", "Mangshir", "Poush", "Magh", "Falgun", "Chaitra" };
        public static NepaliDate Instance;
        public NepaliDate()
        {
            ...
            nepaliMonths = new int[][]{
                new int[] { 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31 }, //2000
			    new int[] { 31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30 },	//2001
                ...
                new int[] { 31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31 },
                new int[] { 31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30 },
                new int[] { 31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30 },  //2071
			    new int[] { 31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30 },  //2072
			    ...
			    new int[] { 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30 },
                new int[] { 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30 },	//2090
			    new int[] { 31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30 },
                new int[] { 30, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30 },
                new int[] { 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30 },
                new int[] { 31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30 },
                new int[] { 31, 31, 32, 31, 31, 31, 30, 29, 30, 30, 30, 30 },
                new int[] { 30, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30 },
                new int[] { 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30 },
                new int[] { 31, 31, 32, 31, 31, 31, 29, 30, 29, 30, 29, 31 },
                new int[] { 31, 31, 32, 31, 31, 31, 30, 29, 29, 30, 30, 30 }  //2099
		    };
        }
        /// <summary>
        /// 
        ...
        public void setCurrentDate()
        {
            ...
            int d = int.Parse(DateTime.Now.ToString("dd"));
        ...
        public int countleap(int year, int month)
        {
            ...
            return (int)((int)year / 4 - (int)year / 100 + (int)year / 400);
        }

        private bool isEnglishRange(int year, int month, int date)
        {
        ...
        /// <summary>
        /// English to Nepali date conversionse
        /// </summary>
        /// <param name="year"></param>
        /// <param name="month"></param>
        /// <param name="date"></param>
        public void setEnglishDate(int year, int month, int date)
        {
        ...
        public void setNepaliDate(int year, int month, int date)
        {
        ...
        private bool isNepaliRange(int year, int month, int date)
        {
